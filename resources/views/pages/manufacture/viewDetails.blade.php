        ...
        <div class="row">
            ...
            <div class="col-md-6">
                ...
                <a href="{{ route('download_manufacture_details', encrypt_decrypt($obj->id, 'encrypt')) }}"
                    target="_blank" class="btn bg-second-btn print_btn">
                    ...
                    <div class="m-auto b-r-5">
                        <table>
                            <tr>
                                <td class="w-50">
                                    ...
                                    <p class="pb-7 rgb-71">@lang('index.email') : {{ safe(getCompanyInfo()->email) }}
                                    </p>
                                    <p class="pb-7 rgb-71">@lang('index.phone') : {{ safe(getCompanyInfo()->phone) }}
                                    </p>
                                    <p class="pb-7 rgb-71">@lang('index.website') :
                                        {{ safe(getCompanyInfo()->web_site) }}
                                    </p>
                                </td>
                                    ...
                                    <div class="pt-20">
                                        ...
                                        <div class="">
                                            ...
                                            <a class="text-decoration-none"
                                                href="{{ $baseURL }}uploads/manufacture/{{ $file }}" target="_blank">
                        ...
                        <table class="mt-50">
                            <tr>
                                ...
                                <td class="w-50 text-right">
                                    <p class="rgb-71 d-inline border-top-e4e5ea pt-10">
                                        @lang('index.authorized_signature')</p>
                                </td>
                            </tr>
                        </table>
                    </div>
