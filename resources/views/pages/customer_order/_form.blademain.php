...
<div>
    ...
    <div class="row mt-3">
    <div class="col-md-12">
        <button type="button" class="btn bg-blue-btn" data-bs-toggle="modal" data-bs-target="#rawMaterialModal">
            <i class="fa fa-plus"></i> Add Raw Material Details
        </button>
    </div>
</div>
    ...
    <div class="row mt-3">
    <div class="col-md-12">
        <button class="btn bg-blue-btn" data-bs-toggle="modal" data-bs-target="#rawMaterialModal" type="button">
            <iconify-icon icon="solar:add-circle-broken"></iconify-icon>
            @lang('index.add_raw_material_details')
        </button>
    </div>
</div>
    ...
    <div class="modal-dialog modal-xl">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <table class="table table-bordered" id="rawMaterialTable">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td>
                                <input type="text" name="raw_material[]" class="form-control" placeholder="Raw Material Name">
                            </td>

                            <td>
                                <input type="text" name="potency[]" class="form-control" placeholder="Potency">
                            </td>

                            <td>
                                <input type="number" name="rm_quantity[]" class="form-control" placeholder="Quantity">
                            </td>
                ...
                <button type="button" id="addRawMaterialRow" class="btn btn-primary">
                    <i class="fa fa-plus"></i> Add More
                </button>
            </div>

            <div class="modal-footer">
                <button type="button" class="btn bg-second-btn" data-bs-dismiss="modal">Close</button>
                <button type="button" class="btn bg-blue-btn" data-bs-dismiss="modal">Save</button>
            </div>
...
$(document).ready(function () {
    ...
    $('#addRawMaterialRow').click(function () {
        let newRow = `
            <tr>
                <td>
                    <input type="text" name="raw_material[]" class="form-control" placeholder="Raw Material Name">
    ...
    $(document).on('click', '.removeRow', function () {
        if ($('#rawMaterialTable tbody tr').length > 1) {
