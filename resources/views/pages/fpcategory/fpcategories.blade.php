...
<section class="main-content-wrapper">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; width:100%;">
            <div>
                <h2 class="top-left-header">
                    {{ isset($title) && $title ? $title : 'Product Categories' }}
                </h2>
    ...
    <div class="box-wrapper">
        ...
        <div class="table-box mb-4">
            ...
            <form action="{{ route('fpcategories.store') }}" method="POST">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <label>Code</label>
                        <input type="text" name="code" class="form-control" value="{{ $nextCode }}" readonly>
                    </div>
                    <div class="col-md-4 mb-3">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="ir_txt_center">
                                ...
                                <!-- Delete -->
                                <form action="{{ route('fpcategories.destroy', $value->id) }}" method="POST"
                        ...
                        <div class="modal fade" id="editModal{{ $value->id }}" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('fpcategories.update', $value->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')
