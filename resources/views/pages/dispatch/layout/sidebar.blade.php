        ...
        <ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
            ...
            <li>
                <a href="javascript:void(0)">
                    ...
                    <span class="match_bold">Dispatch Orders</span>
                </a>
            </li>
            ...
            <li>
                <a href="javascript:void(0)">
                    ...
                    <span class="match_bold">Shipment Planning
</span>
                </a>
            </li>
            ...
            <li>
                <a href="javascript:void(0)">
                    ...
                    <span class="match_bold">Vehicle Management
</span>
                </a>
            </li>
            ...
            <li>
                <a href="javascript:void(0)">
                    ...
                    <span class="match_bold">Tracking</span>
                </a>
            </li>
            ...
            <li>
                <a href="javascript:void(0)">
                    ...
                    <span class="match_bold">Delivery Confirmation
</span>
                </a>
            </li>
