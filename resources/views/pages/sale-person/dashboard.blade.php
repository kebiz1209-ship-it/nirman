...
<section class="main-content-wrapper dashboard-wrapper">
    ...
    <section class="content-header dashboard_content_header my-2">
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
            <div>
                <h3 class="top-left-header mb-0">Sales Dashboard</h3>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="kpi-card kpi-indigo">
                <div class="kpi-inner">
                    <span class="kpi-label">Follow Ups</span>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="kpi-card kpi-emerald">
                <div class="kpi-inner">
                    <span class="kpi-label">Manufacturing Queries</span>
    ...
    <div class="row">
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="kpi-card kpi-violet">
                <div class="kpi-inner">
                    <span class="kpi-label">Sample Pending</span>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="kpi-card kpi-cyan">
                <div class="kpi-inner">
                    <span class="kpi-label">Commercial Orders</span>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="kpi-card kpi-orange">
                <div class="kpi-inner">
                    <span class="kpi-label">Dispatch Pending</span>
        ...
        <div class="col-lg-3 col-sm-6">
            <div class="kpi-card kpi-teal">
                <div class="kpi-inner">
                    <span class="kpi-label">Payment Pending</span>
