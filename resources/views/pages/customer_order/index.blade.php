            ...
            <div>
                @if (routePermission('order.create'))
                    <a href="{{ route('customer-orders.create') }}"
                       class="btn btn-primary {{ request()->routeIs('customer-orders.create') ? 'active' : '' }}">
                        <i class="fa fa-plus"></i> @lang('index.add_order')
                    </a>
                @endif
            </div>
            <div>
                @if (routePermission('order.create'))
                    <a href="{{ route('orders.create') }}"
                       class="btn btn-primary {{ request()->routeIs('orders.create') ? 'active' : '' }}">
                        <i class="fa fa-plus"></i> @lang('index.add_order')
                    </a>
                @endif
            </div>
                                ...
                                <td>
                                    ...
                                    @if (routePermission('order.print-invoice'))
                                        <a href="javascript:void(0)"
                                           class="button-info print_invoice"
                                           data-id="{{ $value->id }}"
                                           data-bs-toggle="tooltip"
