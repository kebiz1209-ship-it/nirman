    ...
    <section class="main-content-wrapper">
        ...
        <section class="content-header">
            <div class="row">
                ...
                <div class="col-md-6">
                    <a href="{{ route('print-quotation', encrypt_decrypt($obj->id, 'encrypt')) }}" target="_blank" class="btn bg-second-btn"
                    ...
                    <div class="card-body p30">
                        <div class="m-auto b-r-5">
                            ...
                            <div class="text-center pt-10 pb-10">
                                <h2 class="color-000000 pt-20 pb-20">@lang('index.quotation')</h2>
                            </div>
                            <table>
                                <tr>
                                    <td class="w-50">
                                    ...
                                    <td class="w-50 text-right align-baseline">
                                    ...
                                    @if (isset($quotation_details) && $quotation_details)
                                        @foreach ($quotation_details as $key => $value)
                                            ...
                                            <tr class="rowCount" data-id="{{ $productInfo->id }}">
                                                ...
                                                <td class="text-start">
                                                    {{ $productInfo->name }}</td>
                                                    <td class="text-center">{{ getCurrency($value->unit_price) }}</td>
                                                <td class="text-center">{{ $value->quantity_amount }}
                                                    {{ getRMUnitById($productInfo->unit) }}</td>
                                                <td class="text-end">{{ getCurrency($value->total) }} </td>
                                            </tr>
                                        @endforeach
                                    @endif
                                </tbody>
                                    ...
                                    <td class="w-50">
                                        ...
                                        <table class="mt-10 mb-10">
                                            <tr>
                                                ...
                                                <td class="w-50 text-right pr-0">
                                                    <p>{{ getCurrency($obj->grand_total) }}</p>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.convert-to-sales-btn').on('click', function(e) {
                e.preventDefault();
                var form = $('#convert-to-sales-form');
