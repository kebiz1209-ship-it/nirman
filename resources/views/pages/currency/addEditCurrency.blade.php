...
<section class="main-content-wrapper">
    ...
    <div class="box-wrapper">
        ...
        <div class="table-box">
                    ...
                    <div class="col-sm-12 mb-2 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="symbol" id="symbol"
                                class="form-control @error('symbol') is-invalid @enderror" placeholder="symbol"
                                value="{{ isset($obj) && $obj->symbol ? $obj->symbol : old('symbol') }}">
                            @error('symbol')
                    ...
                    <div class="col-sm-12 mb-2 col-md-4">
                        <div class="form-group">
                            ...
                            <input type="text" name="currency_name" id="currency_name"
                                ...
                                value="{{ isset($obj) && $obj->currency_name ? $obj->currency_name : old('currency_name') }}">
            ...
            <div class="col-sm-12 mb-2 col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" name="conversion_rate" id="conversion_rate"
                        ...
                        value="{{ isset($obj) && $obj->conversion_rate ? $obj->conversion_rate : old('conversion_rate') }}">
            ...
            <!-- <div class="col-sm-12 mb-2 col-md-4">
    <div class="form-group">
        <label>INR Value <span class="required_star">*</span></label>
        <input type="text" name="inr_value" class="form-control"
            value="{{ isset($obj->inr_value) ? $obj->inr_value : old('inr_value') }}">
        ...
        @enderror
            ...
            <div class="row mt-2">
                <div class="col-sm-12 col-md-6 mb-2 d-flex gap-3">
                    ...
                    <a class="btn bg-second-btn" href="{{ route('currency.index') }}">
