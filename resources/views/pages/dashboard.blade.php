...
<input type="hidden" name="supplier_due_payment_text" id="supplier_due_payment_text_value"
    value="@lang('index.supplier_payment')">
<input type="hidden" name="non_inventory_cost_text" id="non_inventory_cost_text_value"
    value="@lang('index.non_inventory_cost')">
<input type="hidden" name="sale_text" id="sale_text_value" value="@lang('index.sale')">
<input type="hidden" name="customer_due_received_text" id="customer_due_received_text_value"
    value="@lang('index.customer_due_received')">
        ...
        <div class="col-lg-3 col-sm-6">
            <a class="text-dec-none" href="{{ route('rawmaterials.index') }}">
                <div class="small-box box4column">
                    ...
                    <div class="icon">
                        <img src="{!! $baseURL . 'frequent_changing/images/raw-materials.png' !!}" alt="" class="">
                    </div>
                </div>
            </a>
        </div>
        <div class="col-lg-3 col-sm-6">
            <a class="text-dec-none" href="{{ route('suppliers.index') }}">
                <div class="small-box box4column">
                    ...
                    <div class="icon">
                        <img src="{!! $baseURL . 'frequent_changing/images/supplier.png' !!}" alt="" class="">
                    </div>
                </div>
            </a>
        </div>
        <div class="col-lg-3 col-sm-6">
            <a class="text-dec-none" href="{{ route('customers.index') }}">
                <div class="small-box box4column">
                    ...
                    <div class="icon">
                        <img src="{!! $baseURL . 'frequent_changing/images/customer.png' !!}" alt="" class="">
                    </div>
                </div>
            </a>
        </div>
    ...
    <div class="row grap-row">
        <div class="col-xl-8 col-xs-12">
            <div class="card graph_card">
                <div class="d-flex justify-content-between">
                    <h3 class="custom-card-title mb-0 mt-2 ms-3">
                        <iconify-icon icon="solar:chart-broken"></iconify-icon><span
                            class="ms-2">@lang('index.money_flow_comparison')</span>
        ...
        <div class="col-xl-4 col-xs-12">
            <div class="card">
                <div class="d-flex justify-content-between">
                    <h3 class="custom-card-title mb-0 mt-2 ms-3">
                        <iconify-icon icon="solar:pie-chart-2-broken"></iconify-icon><span
        ...
        <div class="col-md-6">
            <div class="box-wrapper">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <iconify-icon icon="solar:database-broken"></iconify-icon><span
                            class="ms-2">@lang('index.running_productions')</span>
                    </h3>
                    <input type="hidden" class="datatable_name" data-title="{{ isset($title) && $title ? $title : '' }}"
                        data-id_name="datatable_1">
                </div>
        ...
        <div class="col-md-6">
            <div class="box-wrapper">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <iconify-icon icon="solar:database-broken"></iconify-icon><span
                            class="ms-2">@lang('index.running_customer_order')</span>
                    </h3>
                    <input type="hidden" class="datatable_name" data-title="{{ isset($title) && $title ? $title : '' }}"
                        data-id_name="datatable_2">
                </div>
                <div class="table-box mt-2">
                    <!-- /.box-header -->
                    <div class="table-responsive">
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="box-wrapper">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <iconify-icon icon="solar:danger-broken"></iconify-icon><span
                            class="ms-2">@lang('index.low_raw_materials_in_stocks')</span>
                    </h3>
                    <input type="hidden" class="datatable_name" data-title="{{ isset($title) && $title ? $title : '' }}"
                        data-id_name="datatable_3">
                </div>
                <div class="table-box mt-2">
                    <!-- /.box-header -->
                    <div class="table-responsive">
        ...
        <div class="col-md-6">
            <div class="box-wrapper">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <iconify-icon icon="solar:close-circle-broken"></iconify-icon><span
                            class="ms-2">@lang('index.close_to_expire_finished_product')</span>
                    </h3>
                    <input type="hidden" class="datatable_name" data-title="{{ isset($title) && $title ? $title : '' }}"
                        data-id_name="datatable_4">
                </div>
                <div class="table-box mt-2">
                    <!-- /.box-header -->
                    <div class="table-responsive">
    ...
    <div class="row mt-3">
        <div class="col-md-6">
            <div class="box-wrapper">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <iconify-icon icon="solar:card-send-broken"></iconify-icon><span
                            class="ms-2">@lang('index.supplier_receivables')</span>
                    </h3>
                    <input type="hidden" class="datatable_name" data-title="{{ isset($title) && $title ? $title : '' }}"
                        data-id_name="datatable_5">
                </div>
                <div class="table-box mt-2">
                    <!-- /.box-header -->
                    <div class="table-responsive">
        ...
        <div class="col-md-6">
            <div class="box-wrapper">
                <div class="box-header with-border">
                    <h3 class="box-title">
                        <iconify-icon icon="solar:card-recive-broken"></iconify-icon><span
                            class="ms-2">@lang('index.customer_payable')</span>
                    </h3>
                    <input type="hidden" class="datatable_name" data-title="{{ isset($title) && $title ? $title : '' }}"
                        data-id_name="datatable_6">
                </div>
                <div class="table-box mt-2">
                    <!-- /.box-header -->
                    <div class="table-responsive">
