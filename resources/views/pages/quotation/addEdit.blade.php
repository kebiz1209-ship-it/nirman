                ...
                <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-group custom_table mt-2">
                                                ...
                                                <div class="image-preview-container">
                                                    @if (isset($obj->file) && $obj->file)
                                                        ...
                                                        @foreach ($files as $file)
                                                            ...
                                                            <div class="file-preview-item d-inline-block position-relative me-2 mb-2" data-filename="{{ $file }}">
                                                                @if ($fileExtension == 'pdf')
                                                                    <a class="text-decoration-none"
                                                                        href="{{ $baseURL }}uploads/quotation/{{ $file }}"
                                                                        target="_blank">
                                                                        <img src="{{ $baseURL }}assets/images/pdf.png"
                                                                            alt="PDF Preview" class="img-thumbnail"
                                                                            width="100px">
                                                                    </a>
                                                                @elseif($fileExtension == 'doc' || $fileExtension == 'docx')
                                                                    <a class="text-decoration-none"
                                                                        ...
                                                                        <img src="{{ $baseURL }}assets/images/word.png"
                                                                            alt="Word Preview" class="img-thumbnail"
                                                                            width="100px">
                                                                    </a>
                                                                @else
                                                                    <a class="text-decoration-none"
                                                                        ...
                                                                        <img src="{{ $baseURL }}uploads/quotation/{{ $file }}"
                                                                            alt="File Preview" class="img-thumbnail"
                                                                            width="100px">
                                                                    </a>
                                                                @endif
                                                                <button type="button" class="btn btn-sm btn-danger remove-file-btn position-absolute" 
                                                                        ...
                                                                        data-filename="{{ $file }}" title="Remove">
