            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    @if (routePermission('quotation.create'))
                        <form action="{{ route('quotation.convert-from-sales', encrypt_decrypt($obj->id, 'encrypt')) }}" 
                              method="POST" 
                              id="convert-to-quotation-form"
                              style="display: inline-block;">
                            @csrf
                            <button type="button" 
                                    class="btn bg-second-btn convert-to-quotation-btn">
                                <iconify-icon icon="solar:exchange-broken"></iconify-icon>
                                @lang('index.convert_to_quotation')
                            </button>
                        </form>
                    @endif
...
@section('script')
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.convert-to-quotation-btn').on('click', function(e) {
                e.preventDefault();
                var form = $('#convert-to-quotation-form');
