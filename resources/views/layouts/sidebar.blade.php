...
<section class="sidebar">
    ...
    <div id="left_menu_to_scroll">
        <ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
            ...
            @endif
            @if (menuPermission('Outlets'))
            <li class="parent-menu treeview2 menu_assign_class menu__cidirp_1{{ request()->is('outlets*') ? ' menu-open active_sub_menu' : '' }}"
                data-menu__cid="irp_1">
                <a href="{{ route('outlets.index') }}">
                    <iconify-icon icon="solar:buildings-2-broken"></iconify-icon>
                    <span class="match_bold">@lang('index.outlets')</span>
                </a>
            </li>
            @endif
    ...
    : '' }}" data-title="Sales">
            ...
            <li class="parent-menu treeview menu__cidirp_10 
                ...
                <a href="#">
                    ...
                    <span class="match_bold">@lang('index.production')</span>
                </a>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="{{ request()->routeIs('productions.create') ? 'treeMenuActive' : '' }}">
                        <a href="{{ route('productions.create') }}">
                            @lang('index.add_manufacture')
                        </a>
                    </li>
                    @endif

                    {{-- Manufacture List --}}
                    @if (routePermission('production.index'))
                    <li class="{{ request()->routeIs('productions.index') ? 'treeMenuActive' : '' }}">
                        <a href="{{ route('productions.index') }}">
                            @lang('index.manufacture_list')
                        </a>
                    </li>
                    @endif

                    {{-- Production Loss Create --}}
                    @if (routePermission('production-loss.create'))
                    <li class="{{ request()->routeIs('production-loss') ? 'treeMenuActive' : '' }}">
                        <a href="{{ route('production-loss') }}">
                            @lang('index.add_production_loss')
                        </a>
                    </li>
                    @endif

                    {{-- Production Loss List --}}
                    @if (routePermission('production-loss.index'))
                    <li class="{{ request()->routeIs('production-loss-report') ? 'treeMenuActive' : '' }}">
                        <a href="{{ route('production-loss-report') }}">
                            @lang('index.production_loss_list')
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="{{ request()->routeIs('forecasting.order') ? 'treeMenuActive' : '' }}">
                        <a href="{{ route('forecasting.order') }}">
                            @lang('index.demand_forecasting_by_order')
                        </a>
                    </li>
                    @endif
                    ...
                    <li class="{{ request()->routeIs('forecasting.product') ? 'treeMenuActive' : '' }}">
                        <a href="{{ route('forecasting.product') }}">
                            @lang('index.demand_forecasting_by_product')
                        </a>
                    </li>
                    @endif
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('attendance.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
                            href="{{ route('attendance.create') }}">@lang('index.add_attendance')</a>
                    </li>
                    @endif
                    @if (routePermission('attendance.index'))
                    <li class="menu_assign_class {{ request()->routeIs('attendance.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('expense.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('expense.create') }}">@lang('index.add_expense')</a>
                    </li>
                    @endif
                    @if (routePermission('expense.index'))
                    <li class="menu_assign_class {{ request()->routeIs('expense.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('expense.index') }}">@lang('index.expense_list')</a>
                    </li>
                    @endif
                    @if (routePermission('expensecategory.create'))
                    <li class="menu_assign_class {{ request()->routeIs('expense-category.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
                            href="{{ route('expense-category.create') }}">@lang('index.add_expense_category')</a>
                    </li>
                    @endif
                    @if (routePermission('expensecategory.index'))
                    <li class="menu_assign_class {{ request()->routeIs('expense-category.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('accounts.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('accounts.create') }}">@lang('index.add_account')</a>
                    </li>
                    @endif
                    @if (routePermission('account.index'))
                    <li class="menu_assign_class {{ request()->routeIs('accounts.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('accounts.index') }}">@lang('index.list_account')</a>
                    </li>
                    @endif
                    @if (routePermission('deposit.create'))
                    <li class="menu_assign_class {{ request()->routeIs('deposit.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
                            href="{{ route('deposit.create') }}">@lang('index.add_deposit_or_withdraw')</a>
                    </li>
                    @endif
                    @if (routePermission('deposit.index'))
                    <li class="menu_assign_class {{ request()->routeIs('deposit.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
                            href="{{ route('deposit.index') }}">@lang('index.list_deposit_or_withdraw')</a>
                    </li>
                    @endif
                    @if (routePermission('balancesheet'))
                    <li class="menu_assign_class {{ request()->routeIs('balance-sheet') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('balance-sheet') }}">@lang('index.balance_sheet')</a>
                    </li>
                    @endif
                    @if (routePermission('trialbalance'))
                    <li class="menu_assign_class {{ request()->routeIs('trial-balance') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('trial-balance') }}">@lang('index.trial_balance')</a>
                    </li>
                    @endif
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('supplier-payment.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
                            href="{{ route('supplier-payment.create') }}">@lang('index.add_supplier_payment')</a>
                    </li>
                    @endif
                    @if (routePermission('sp.index'))
                    <li class="menu_assign_class {{ request()->routeIs('supplier-payment.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('customer-payment.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
                            href="{{ route('customer-payment.create') }}">@lang('index.add_customer_receive')</a>
                    </li>
                    @endif
                    @if (routePermission('cd.index'))
                    <li class="menu_assign_class {{ request()->routeIs('customer-payment.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('payroll.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('payroll.create') }}">@lang('index.add_payroll')</a>
                    </li>
                    @endif
                    @if (routePermission('payroll.index'))
                    <li class="menu_assign_class {{ request()->routeIs('payroll.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('payroll.index') }}">@lang('index.list_payroll')</a>
                    </li>
                    @endif
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('rmwastes.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('rmwastes.create') }}">@lang('index.add_rm_waste')</a>
                    </li>
                    @endif
                    @if (routePermission('rmwaste.index'))
                    <li class="menu_assign_class {{ request()->routeIs('rmwastes.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('rmwastes.index') }}">@lang('index.list_rm_waste')</a>
                    </li>
                    @endif
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('product-wastes.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
                            href="{{ route('product-wastes.create') }}">@lang('index.add_product_waste')</a>
                    </li>
                    @endif
                    @if (routePermission('productwaste.index'))
                    <li class="menu_assign_class {{ request()->routeIs('product-wastes.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('quotation.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('quotation.create') }}">@lang('index.add_quotion')</a>
                    </li>
                    @endif
                    @if (routePermission('quotations.index'))
                    <li class="menu_assign_class {{ request()->routeIs('quotation.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('quotation.index') }}">@lang('index.quotion_list')</a>
                    </li>
                    @endif
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('role.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('role.create') }}">@lang('index.add_role')</a>
                    </li>
                    @endif
                    @if (routePermission('role.index'))
                    <li class="menu_assign_class {{ request()->routeIs('role.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('role.index') }}">@lang('index.list_role')</a>
                    </li>
                    @endif
                    @if (routePermission('user.create'))
                    <li class="menu_assign_class {{ request()->routeIs('user.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('user.create') }}">@lang('index.add_user')</a>
                    </li>
                    @endif
                    @if (routePermission('user.index'))
                    <li class="menu_assign_class {{ request()->routeIs('user.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('user.index') }}">@lang('index.list_user')</a>
                    </li>
                    @endif
                </ul>
            </li>
            ...
            <li
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="menu_assign_class {{ request()->routeIs('settings') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('settings') }}">
                            @lang('index.company_profile')
                        </a>
                    </li>
                    @endif
                    @if (routePermission('taxes'))
                    <li class="menu_assign_class {{ request()->routeIs('taxes') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('taxes') }}">@lang('index.tax_settings')</a>
                    </li>
                    @endif
                    @if (isWhiteLabelChangeAble())
                    @if (routePermission('white-label'))
                    <li class="menu_assign_class {{ request()->routeIs('white-label') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('white-label') }}">@lang('index.white_label')</a>
                    </li>
                    @endif
                    @endif
                    @if (routePermission('mail-settings'))
                    <li class="menu_assign_class {{ request()->routeIs('settings.mail.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
                            href="{{ route('settings.mail.index') }}">@lang('index.mail_settings')</a>
                    </li>
                    @endif
                    @if (routePermission('productionstage.list'))
                    <li class="menu_assign_class {{ request()->routeIs('data-import') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('data-import') }}">@lang('index.data_import')</a>
                    </li>
                    @endif
                    @if (routePermission('units.create'))
                    <li class="menu_assign_class {{ request()->routeIs('units.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('units.create') }}">@lang('index.add_unit')</a>
                    </li>
                    @endif
                    @if (routePermission('currency.index'))
                    <li class="menu_assign_class {{ request()->routeIs('currency.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('currency.index') }}">@lang('index.list_currency')</a>
                    </li>
                    @endif
                    @if (routePermission('currency.create'))
                    <li class="menu_assign_class {{ request()->routeIs('currency.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('currency.create') }}">@lang('index.add_currency')</a>
                    </li>
                    @endif
                    @if (routePermission('units.index'))
                    <li class="menu_assign_class {{ request()->routeIs('units.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a href="{{ route('units.index') }}">@lang('index.list_unit')</a>
                    </li>
                    @endif
                    @if (routePermission('productionstage.create'))
                    <li class="menu_assign_class {{ request()->routeIs('productionstages.create') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
                            href="{{ route('productionstages.create') }}">@lang('index.add_production_stage')</a>
                    </li>
                    @endif
                    @if (routePermission('productionstage.list'))
                    <li class="menu_assign_class {{ request()->routeIs('productionstages.index') ? ' treeMenuActive' : '' }}"
                        data-menu__cid="irp_10"><a
...
$(document).on('click', '.ajax-link', function(e) {
    ...
    $('.content-wrapper').html('<div class="text-center p-5">Loading...</div>');

    $.ajax({
        url: url,
        type: "GET",
        success: function(response) {
            // Extract only content part
            let html = $(response).find('.content-wrapper').html();
