...
<section class="main-content-wrapper">
    <section class="content-header d-flex justify-content-between align-items-center mb-3">
        ...
        <a href="{{ route('pages.sales.order.create') }}" class="btn btn-secondary back-btn">
        ...
        <form method="POST" action="{{ route('products.store') }}" id="productForm">
            ...
            <div class="product-tabs">
                <ul class="nav nav-tabs flex-wrap" id="productTabs" role="tablist">
                    ...
                    <li class="nav-item">
                        <button class="nav-link" id="ingredient-tab" data-bs-toggle="tab" data-bs-target="#ingredient"
                            type="button">
                            Ingredient
                        </button>
                    </li>
