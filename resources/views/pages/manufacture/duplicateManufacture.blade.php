        ...
        <div class="table-box">
            ...
            <div>
                <div class="row">
                    ...
                    <div class="col-sm-12 col-md-6 mb-2 col-lg-4">
                        <div class="form-group">
                            ...
                            {!! Form::text(
                            'start_date',
                            isset($obj->start_date) && $obj->start_date ? $obj->start_date : date('Y-m-d',
                            strtotime('today')),
                            ['class' => 'form-control customDatepicker', 'readonly' => '', 'placeholder' => 'Start
                            Date'],
                            ) !!}
                    ...
                    <div class="col-sm-12 col-md-6 mb-2 col-lg-4">
                        <div class="form-group">
                            ...
                            {!! Form::text(
                            'complete_date',
                            isset($obj->complete_date) && $obj->complete_date ? $obj->complete_date : date('Y-m-d',
                            strtotime('today')),
                            ['class' => 'form-control customDatepicker', 'readonly' => '', 'placeholder' => 'Complete
                            Date'],
                            ) !!}
                    ...
                    <div
                        class="col-sm-12 mb-2 col-md-2 none_method batch_method @if(in_array($st_method, ['none', 'batchcontrol'])) d-none @endif">
                        <div class="form-group">
                    ...
                    <div class="col-sm-12 mb-2 col-md-2">
                        <div class="form-group">
                            <button id="pr_go" class="btn bg-blue-btn w-100 goBtn govalid">@lang('index.go')</button>
                        </div>
                    </div>
                    <div class="clearfix"></div>
                    <div class="clearfix"></div>
                                        ...
                                        <td>
                                            <div class="input-group">
                                                <input type="number" id="total_1" name="total[]"
                                                    class="form-control total_c" value="{{ $value->consumption_unit }}"
                                        ...
                                        <tr class="rowCount1" data-id="{{ $value->noninvemtory_id }}">
                                            ...
                                            <td width="20%">
                                                <select class="form-control select2" name="account_id[]"
                                                    ...
                                                    <option @selected(isset($value->account_id) && $value->account_id ==
                                                        $account->id)
                                    ...
                                    <tbody class="add_tstage">
                                        ...
                                        <tr class="rowCount2" data-id="{{ $value->productionstage_id }}">
                                            ...
                                            <td class="width_1_p"><input class="form-check-input set_class"
                                                    ...
                                                    type="radio" name="stage_check" value="{{ $i }}" {{ $checked }}>
                                            </td>
                                            ...
                                            <td>
                                                <div class="row">
                                                    <div class="col-md-3">
                                                        <div class="input-group">
                                                            <input class="form-control stage_aligning" type="text"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="input-group">
                                                            <input class="form-control stage_aligning" type="text"
                                                                id="day_limit" name="stage_day[]" min="0" max="31"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="input-group">
                                                            <input class="form-control stage_aligning" type="text"
                                                                id="hours_limit" name="stage_hours[]" min="0" max="24"
                                                    ...
                                                    <div class="col-md-3">
                                                        <div class="input-group">
                                                            <input class="form-control stage_aligning" type="text"
                                                                id="minute_limit" name="stage_minute[]" min="0" max="60"
                ...
                <div class="row">
                    ...
                    <?php
$collect_tax = isset($tax_items) && $tax_items ? $tax_items->collect_tax : 'No';
                ...
                <div class="row">
                    <div class="col-sm-6 col-md-6 mb-2">
                        <div class="form-group">
                            ...
                            {!! Form::textarea('note', null, ['class' => 'form-control', 'id' => 'note', 'placeholder'
                            => 'Note']) !!}
                        </div>
                    </div>
                                ...
                                <tbody>
                                    <tr>
                                        <td width="100%">
                                            ...
                                            'id' => 'file_button',
                                            'accept' =>
                                            'image/png,image/jpeg,image/jgp,image/gif,application/pdf,.doc,.docx',
