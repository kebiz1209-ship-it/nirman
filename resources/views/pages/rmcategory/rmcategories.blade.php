...
<section class="main-content-wrapper">
        ...
        <div style="display:flex; justify-content:space-between; align-items:center; width:100%;">
            <div>
                <h2 class="top-left-header">
                    {{ isset($title) && $title ? $title : 'RM Categories' }}
                </h2>
    ...
    <div class="box-wrapper">
        ...
        <div class="table-box mb-4">
            <h4>Add Raw Material Category</h4>

            <form action="{{ route('rmcategories.store') }}" method="POST">
                @csrf
                        ...
                        <div class="modal fade" id="editModal{{ $value->id }}" tabindex="-1">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    <form action="{{ route('rmcategories.update', $value->id) }}" method="POST">
                                        @csrf
                                        @method('PATCH')

                                        <div class="modal-header">
                                            <h5>Edit RM Category</h5>
                                            <button type="button"
                                                class="btn-close"
