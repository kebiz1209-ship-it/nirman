    ...
    <div class="form-group">
        ...
        @enderror
                        ...
                        <!-- <div
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" name="expiry_days" id="expiry_days" min="1"
                        ...
                        <div id="expiry_wrapper" class="col-sm-12 mb-2 col-md-2 none_method batch_method 
        @if (in_array($st_method, ['none', 'batchcontrol', 'fifo'])) d-none @endif">

                            <div class="form-group">
                                <label>
                                    @lang('index.expiry_days')
        ...
        placeholder="Expiry Days"
        value="{{ isset($obj->expiry_days) ? $obj->expiry_days : old('expiry_days') }}"
        @if(in_array($st_method, ['none','batchcontrol','fifo'])) disabled @endif
    >
                        ...
                        <div class="col-sm-12 mb-2 col-md-2">
                            <div class="form-group">
                                <button id="pr_go"
                                    class="btn bg-blue-btn w-100 goBtn govalid"><span
                                        class="me-2">@lang('index.go')</span>
                                ...
                                <table class="table">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="w-20"> @lang('index.rate_per_unit') <span
                                                    class="required_star">*</span> <i data-bs-toggle="tooltip"
                                                    data-bs-placement="bottom"
                                                    title="@lang('index.rm_stock_price_calculate')"
                                                    class="fa fa-question-circle base_color c_pointer"></i>
                                            </th>
                                            <th class="w-20"> @lang('index.consumption') <span
                                            ...
                                            <td>
                                                <div class="input-group">
                                                    <input type="number" id="total_1" name="total[]"
                                                        ...
                                                        value="{{ $value->consumption_unit }}" placeholder="Total"
                                                        readonly="">
                                                    <span class="input-group-text">
                                                        {{ $setting->currency }}</span>
                                                </div>
                                                ...
                                                <td width="20%">
                                                    <select class="form-control @error('title') is-invalid @enderror"
                                                        ...
                                                        <option
                                                            ...
                                                            id="account_id" class="account_id" value="{{ $account->id }}">
                                                            {{ $account->name }}
                                                        </option>
                                                        @endforeach
                                                    </select>
                                ...
                                <table>
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="w-20"></td>
                                            <td class="w-20"><label
                                                    class="custom_label">@lang('index.total_non_inventory_cost')</label>
                                                <div class="input-group">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody class="add_tstage">
                                            ...
                                            <?php
                                                        ...
                                                        ?>
                                            <tr class="rowCount2 align-baseline" data-id="{{ $value->productionstage_id }}">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-xl-3 col-md-4">
                                                            <div class="input-group">
                                                                <input
                                                                    ...
                                                                    type="text" id="month_limit" name="stage_month[]"
                                                                    class="form-control @error('title') is-invalid @enderror"
                                                                    min="0" max="12" value="{{ $value->stage_month }}"
                                                        ...
                                                        <div class="col-xl-3 col-md-4">
                                                            <div class="input-group">
                                                                <input
                                                                    class="form-control @error('title') is-invalid @enderror stage_aligning"
                                                                    type="text" id="day_limit" name="stage_day[]" min="0"
                                                        ...
                                                        <div class="col-xl-3 col-md-4">
                                                            <div class="input-group">
                                                                <input
                                                                    class="form-control @error('title') is-invalid @enderror stage_aligning"
                                                                    type="text" id="hours_limit" name="stage_hours[]"
                                                                    min="0" max="24" value="{{ $value->stage_hours }}"
                                                        ...
                                                        <div class="col-xl-3 col-md-4">
                                                            <div class="input-group">
                                                                <input
                                                                    class="form-control @error('title') is-invalid @enderror stage_aligning"
                                                                    type="text" id="minute_limit" name="stage_minute[]"
                                                                    min="0" max="60" value="{{ $value->stage_minute }}"
                        ...
                        <div class="row">
                            <div class="col-xl-12">
                                <div class="table-responsive" id="purchase_cart">
                                    <table class="table">
                                        ...
                                        <tbody class="add_production_scheduling sort_menu">
                                            ...
                                            <tr class="rowCount3" data-id="{{ $value->production_stage_id }}"
                                                ...
                                                <td>
                                                    <select class="form-control manufacture_stage_id changeableInput"
                                                ...
                                                <td>
                                                    <div class="input-group">
                                                        <input type="text" id="start_date" name="start_date[]"
                                                            ...
                                                            value="{{ $value->start_date }}" placeholder="Start Date">
                                                    </div>
                                                </td>
                                                <td>
                                                    <div class="input-group">
                                                        <input type="text" id="complete_date" name="complete_date[]"
                                                            class="form-control @error('title') is-invalid @enderror changeableInput customDatepicker"
                                                            value="{{ $value->end_date }}" placeholder="Complete Date">
                                                    </div>
                                    ...
                                    <button id="scheduling_add" data-bs-toggle="modal" data-bs-target="#productScheduling"
                                        class="btn bg-blue-btn w-20 mt-2" type="button">@lang('index.add_more')</button>
                                </div>
                            </div>
                                            ...
                                            <td width="100%">
                                                ...
                                                <div class="image-preview-container">
                                                    ...
                                                    <a class="text-decoration-none"
                                                        ...
                                                        target="_blank">
                                                        <img src="{{ $baseURL }}assets/images/pdf.png" alt="PDF Preview"
                                                            class="img-thumbnail mx-2" width="100px">
                                                    </a>
                                                    @elseif($fileExtension == 'doc' || $fileExtension == 'docx')
                                                    <a class="text-decoration-none"
                                                        href="{{ $baseURL }}uploads/manufacture/{{ $file }}"
                                                        target="_blank">
                                                        <img src="{{ $baseURL }}assets/images/word.png" alt="Word Preview"
                                                            class="img-thumbnail mx-2" width="100px">
                                                    </a>
                                                    @else
                                                    <a class="text-decoration-none"
                                                        ...
                                                        <img src="{{ $baseURL }}uploads/manufacture/{{ $file }}"
                                                            alt="File Preview" class="img-thumbnail mx-2" width="100px">
                                                    </a>
                                                    @endif
                                                    @endforeach
                                                    @endif
                    ...
                    <div class="row mt-2">
                        <div class="col-sm-12 col-md-6 mb-2 d-flex gap-3">
                            <button type="submit" name="submit" value="submit" class="btn bg-blue-btn submit_btn">
                            ...
                            <button type="button" class="btn bg-blue-btn d-none" id="checkStockButton"
                                data-bs-toggle="modal" data-bs-target="#stockCheck">
                                <iconify-icon icon="solar:info-circle-broken"></iconify-icon>@lang('index.check_stock')
                            </button>
                            <a class="btn bg-second-btn" href="{{ route('productions.index') }}">
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('purchase-generate-customer-order') }}" method="post">
                    ...
                    <div class="modal-footer">
                        <button type="submit" class="btn bg-blue-btn delivaries_button">
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form id="product_scheduling_form">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mb-2 col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="task" class="form-control @error('title') is-invalid @enderror"
                                        id="task" placeholder="Task">
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn bg-blue-btn product_scheduling_button">
    ...
    @section('script')
    <script>
    // Define translation messages as JavaScript variables
    var validationMessages = {
        completeDateGreater: "{{ __('index.complete_date_must_be_greater_than_start_date') }}"
    };
</script>
<script type="text/javascript" src="{!! $baseURL . 'frequent_changing/js/addManufactures.js?v=2.1' !!}"></script>
    ...
    <script type="text/javascript" src="{!! $baseURL . 'assets/bower_components/gantt/js/jquery.cookie.min.js' !!}">
    </script>
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function toggleExpiry() {
        ...
        let productSelect = document.getElementById('fproduct_id');
        let selectedValue = productSelect.value;
        
        // Extract stock_method from the selected option
        let stockMethod = '';
        if (selectedValue) {
        ...
        let wrapper = document.getElementById('expiry_wrapper');
        let field = document.getElementById('expiry_days');
        
        // Hide expiry days for 'none', 'fifo', 'fefo' stock methods
        // Show only for 'batchcontrol' or other methods
        if (['none', 'fifo', 'fefo'].includes(stockMethod)) {
    ...
    // Run when product selection changes
    let productSelect = document.getElementById('fproduct_id');
    if (productSelect) {
        productSelect.addEventListener('change', toggleExpiry);
    }
});
    </script>
...
<script>
// Preserve batch number and expiry days when product changes
$(document).ready(function() {
    var previousBatchNo = $('#batch_no').val();
    var previousExpiryDays = $('#expiry_days').val();
    
    $('#fproduct_id').on('change', function() {
        // Store current values before any changes
        var currentBatchNo = $('#batch_no').val();
        var currentExpiryDays = $('#expiry_days').val();
        
        // Small delay to let other handlers run first
        setTimeout(function() {
            // Restore values if they got cleared
            if ($('#batch_no').val() !== currentBatchNo && currentBatchNo !== undefined) {
                $('#batch_no').val(currentBatchNo);
            }
            if ($('#expiry_days').val() !== currentExpiryDays && currentExpiryDays !== undefined) {
                $('#expiry_days').val(currentExpiryDays);
            }
        }, 100);
    });
});
...
$(document).ready(function() {
    ...
    var completeDateInput = $('#complete_date');
    
    // Create or get the error message element
    var errorDiv = $('<div class="text-danger date-validation-error mt-1" style="display: none;"></div>');
    completeDateInput.closest('.form-group').append(errorDiv);
    
    // Function to validate dates
    function validateDates() {
        var startDate = startDateInput.val();
        var completeDate = completeDateInput.val();
        ...
        if (startDate && completeDate) {
            ...
            // Check if complete date is valid and greater than start date
            if (complete <= start) {
    errorDiv.text(validationMessages.completeDateGreater);
    errorDiv.show();
    completeDateInput.addClass('is-invalid');
    return false;
} else {
                completeDateInput.removeClass('is-invalid');
                return true;
            }
        } else {
            completeDateInput.removeClass('is-invalid');
            return true; // Don't validate if one is missing
        }
    }
    
    // Validate on complete date change
    completeDateInput.on('change', function() {
        validateDates();
    });
    
    // Also validate when start date changes (in case it affects existing complete date)
    ...
    $('form').on('submit', function(e) {
        if (!validateDates()) {
            ...
            // Scroll to the error
            $('html, body').animate({
                scrollTop: completeDateInput.offset().top - 100
            }, 500);
            return false;
        }
    });
    
    // If you're using any datepicker that triggers on select
    if ($.fn.datepicker) {
        startDateInput.on('changeDate', function() {
            validateDates();
        });
        completeDateInput.on('changeDate', function() {
            validateDates();
        });
    }
});
...
<script>
    // Ensure quantity field is editable on the page
    $(document).ready(function() {
        var quantityField = $('#product_quantity');
        quantityField.prop('readonly', false);
        quantityField.removeClass('readonly-bg');
    });
</script>
    @endsection