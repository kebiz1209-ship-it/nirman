...
<ul class="sidebar-menu ps ps--active-x ps--active-y tree" data-widget="tree">
    ...
    <li>
       <a href="javascript:void(0)">
            ...
            <span class="match_bold">Batch Execution</span>
        </a>
    </li>
    ...
    <li>
        <a href="javascript:void(0)">
            ...
            <span class="match_bold">Material Consumption</span>
        </a>
    </li>
    ...
    <li>
        <a href="javascript:void(0)">
            ...
            <span class="match_bold">Machine Log</span>
        </a>
    </li>
    ...
    <li>
        <a href="javascript:void(0)">
            ...
            <span class="match_bold">Production Reports</span>
        </a>
    </li>
