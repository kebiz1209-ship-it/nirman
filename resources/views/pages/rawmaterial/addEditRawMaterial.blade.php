    ...
    <div class="box-wrapper">
        ...
        <div class="table-box">
            ...
            <div class="row">
                ...
                <div class="col-sm-12 mb-2 col-md-4">
                    <label class="custom_label">@lang('index.rate_per_unit')
                        <small>(@lang('index.purchase'))</small><span class="required_star">*</span></label>
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <input type="text" name="grade" class="form-control" placeholder="Enter Grade"
                        value="{{ isset($obj->grade) ? $obj->grade : old('grade') }}">
                </div>

                <!-- Potency -->
                <div class="col-md-3 mb-2">
                    <label>Potency</label>
                    <input type="text" name="potency" class="form-control" placeholder="Enter Potency"
                        value="{{ isset($obj->potency) ? $obj->potency : old('potency') }}">
                </div>
                ...
                <div class="col-md-3 mb-2">
                    ...
                    <input type="text" name="alias" class="form-control" placeholder="Enter Alias"
                        value="{{ isset($obj->alias) ? $obj->alias : old('alias') }}">
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12 mb-2 col-md-4">
                ...
                <div class="col-sm-12 mb-2 col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" name="opening_stock" id="opening_stock"
                            class="form-control @error('opening_stock') is-invalid @enderror integerchk" min="1"
                ...
                <div class="col-sm-12 mb-2 col-md-4">
                    ...
                    <div class="input-group">
                        <input type="text" name="alert_level" id="alert_level"
                            ...
                            value="{{ isset($obj->alert_level) ? $obj->alert_level : old('alert_level') }}">
                        <span class="input-group-text opening_stock_unit">
                            {{ isset($obj) ? (isset($obj->consumption_check) && $obj->consumption_check == '1' ? getRMUnitById($obj->consumption_unit) : getRMUnitById($obj->unit)) : 'pcs' }}
                        </span>
                    </div>
            ...
            <div class="row mt-2">
                <div class="col-sm-12 col-md-6 mb-2 d-flex gap-3">
                    ...
                    <a class="btn bg-second-btn" href="{{ route('rawmaterials.index') }}">
